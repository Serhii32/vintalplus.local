                ...
                <div class="container-fluid py-4 bg-white border rounded border-light shadow">
                    ...
                    {!! Form::open(['route'=>'admin.services.store', 'files' => true]) !!}
                        <div class="form-group">
                            {!! Form::label('main_photo', 'Вибрати главное фото услуги:', ['class' => 'text-uppercase font-weight-bold']) !!}
                        ...
                        @foreach(LaravelLocalization::getLocalesOrder() as $code => $locale)
                            <div class="form-group">
                                ...
                                {!! Form::text('title'.strtoupper($code), old('title'.strtoupper($code)), ['placeholder'=>'Название услуги '.strtoupper($code)] + ($errors->has('title'.strtoupper($code)) ? ['class'=>'form-control is-invalid'] : ['class'=>'form-control'])) !!}
                        ...
                        @endforeach
                        <div class="form-group">
                            {!! Form::submit('Добавить услугу', ['class'=>'btn btn-success w-100 text-uppercase font-weight-bold']) !!}
                        </div>
                    {!! Form::close() !!}
                </div>             
            </div>
