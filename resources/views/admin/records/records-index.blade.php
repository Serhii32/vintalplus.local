                                ...
                                <div class="col-12 col-sm-6 col-md-4 col-lg-3 my-3">
                                    <div class="card h-100 shadow p-2">
                                        <a class="card-link text-secondary p-1" href="{{route('admin.records.edit', $record->id)}}">
                                            <div class="text-center"><img class="img-fluid img-thumbnail" src="{{$record->main_photo ? asset($record->main_photo) : asset('img/common/default.png')}}" alt="{{$record->titleRU}}"></div>
                                            <h4 class="text-center text-uppercase">{{$record->titleRU}}</h4>
                                        </a>
