                    ...
                    {!! Form::open(['route'=>'admin.records.store', 'files' => true]) !!}
                        ...
                        @foreach(LaravelLocalization::getLocalesOrder() as $code => $locale)
                            <div class="form-group">
                                ...
                                {!! Form::text('title'.strtoupper($code), old('title'.strtoupper($code)), ['placeholder'=>'Название новости '.strtoupper($code)] + ($errors->has('title'.strtoupper($code)) ? ['class'=>'form-control is-invalid'] : ['class'=>'form-control'])) !!}
