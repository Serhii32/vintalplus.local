        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-md-9 p-4">
                ...
                <div class="container-fluid py-4 bg-white border rounded border-light shadow">
                    <h2 class="text-center font-weight-bold text-uppercase">Добавить проект</h2>
                    {!! Form::open(['route'=>'admin.records.store', 'files' => true]) !!}
                        <div class="form-group">
                            {!! Form::label('main_photo', 'Вибрати главное фото проекта:', ['class' => 'text-uppercase font-weight-bold']) !!}
                        ...
                        @foreach(LaravelLocalization::getLocalesOrder() as $code => $locale)
                            <div class="form-group">
                                ...
                                {!! Form::text('title'.strtoupper($code), old('title'.strtoupper($code)), ['placeholder'=>'Название проекта '.strtoupper($code)] + ($errors->has('title'.strtoupper($code)) ? ['class'=>'form-control is-invalid'] : ['class'=>'form-control'])) !!}
                        ...
                        @endforeach
                        <div class="form-group">
                            {!! Form::submit('Добавить проект', ['class'=>'btn btn-success w-100 text-uppercase font-weight-bold']) !!}
                        </div>
                    {!! Form::close() !!}
                </div>             
            </div>
