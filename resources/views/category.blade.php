...
<div class="container" style="min-height: 50vh">
	<div class="row">
		...
		<div class="col-12 col-md-8 col-lg-9">
			<h3 class="text-dark font-weight-bold text-uppercase text-center p-4">{{$category->{'title' . strtoupper(App::getLocale())} }}</h3>
			<div class="container">
		            ...
		            @foreach($products as $product)
		                <div class="col-12 col-sm-6 col-md-4 my-3">
		                    <div class="card h-100 shadow p-2">
		                        ...
		                        <h6 class="text-center text-secondary">{{ __('pages.price') }}: {{ number_format($product->price, 2, '.', ' ') }} грн.</h6>
